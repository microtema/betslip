...
import de.seven.fate.betslip.entity.BaseEntity;
...
import static de.seven.fate.betslip.constants.Constants.NO_SUCH_ENTITY;
...
public interface ExtendedCrudRepository<T extends BaseEntity<I>, I extends Serializable> extends JpaRepository<T, I>, JpaSpecificationExecutor<T> {
     ...
     * @return List of EntityProperty, never null
     */
