package de.seven.fate.betslip.interceptor;

import de.seven.fate.betslip.converter.ObjectError2ErrorMessageConverter;
import de.seven.fate.betslip.vo.ErrorMessage;
import de.seven.fate.betslip.vo.ErrorMessageResponse;
...
/**
 * Interceptor for all Components under package: de.seven.fate.betslip.resource
 */
@Aspect
@Component
public class ResourceInterceptor {
    ...
    @Pointcut("within(de.seven.fate.betslip.resource..*)")
